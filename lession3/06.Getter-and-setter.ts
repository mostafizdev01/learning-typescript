{
    ...
    /// learn Getter and setter on typescript
    ...
    class BankAccount {
        ...
        set deposite(depositeAmount: number) {
    ...
    const GoribAccount = new BankAccount(23, "Dutch Bangla Bank", 60)
    // GoribAccount.addDeposit(70)
    // console.log(GoribAccount.getBalance());
    GoribAccount.deposite = 70 // useing setter // create a function but useing property || There is very simple
    console.log(GoribAccount.balance);  /// getter use kore amara function k property akyare use korte pertesi...
